...
typedef enum _fieldtypes
{
	...
	FIELD_POSITION_VECTOR,	// A world coordinate (these are fixed up across level transitions automatically)
...
typedef struct typedescription_s	TYPEDESCRIPTION;	
typedef struct datamap_s		DATAMAP;
...
typedef struct 
{
	...
	void	(*pfnSaveWriteFields)( SAVERESTOREDATA*, const char*, void*, ENGTYPEDESCRIPTION*, int );
	void	(*pfnSaveReadFields)( SAVERESTOREDATA*, const char*, void*, ENGTYPEDESCRIPTION*, int );
