...
DECLARE_FIELD_SIZE( FIELD_ENTITY,		sizeof(long))
DECLARE_FIELD_SIZE( FIELD_CLASSPTR,		sizeof(long))
DECLARE_FIELD_SIZE( FIELD_EHANDLE,		sizeof(long))
DECLARE_FIELD_SIZE( FIELD_EVARS,		sizeof(long))
DECLARE_FIELD_SIZE( FIELD_EDICT,		sizeof(long))
